...
namespace WebAPI.Controllers
{
    public class HomeController : Controller
    {
        ...
        private CosmosSettings cosmosSettings { get; set; }
        ...
        public async Task<IActionResult> Index()
        {
            try
            {
                ...
                //itemService.CreateItem(new HomeInv.Common.Entities.Item()
                //{
                //    Name = "masa"
                //});
            }
            catch (CosmosException de)
            {
                ...
                logger.LogInformation("{0} error occurred: {1}", de.StatusCode, de);
            }
            catch (Exception e)
            {
            ...
            {
                logger.LogInformation("End of demo, press any key to exit.");
            }
            return View();
        }
        ...
        public async Task GetStartedDemoAsync()
        {
            ...
            this.cosmosClient = new CosmosClient(cosmosSettings.EndpointUri, cosmosSettings.PrimaryKey, new CosmosClientOptions() { ApplicationName = "CosmosDBDotnetQuickstart" });
