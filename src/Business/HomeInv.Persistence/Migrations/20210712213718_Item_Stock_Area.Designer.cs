...
namespace HomeInv.Persistence.Migrations
{
    ...
    [Migration("20210712213718_Item_Stock_Area")]
    partial class Item_Stock_Area
    {
            ...
            modelBuilder.Entity("HomeInv.Persistence.Dbo.Area", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 7, 12, 21, 37, 18, 701, DateTimeKind.Utc).AddTicks(5492));
            ...
            modelBuilder.Entity("HomeInv.Persistence.Dbo.Home", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 12, 21, 37, 18, 703, DateTimeKind.Utc).AddTicks(5792));
            ...
            modelBuilder.Entity("HomeInv.Persistence.Dbo.HomeUser", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 12, 21, 37, 18, 703, DateTimeKind.Utc).AddTicks(6629));
            ...
            modelBuilder.Entity("HomeInv.Persistence.Dbo.Item", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 12, 21, 37, 18, 703, DateTimeKind.Utc).AddTicks(7242));
            ...
            modelBuilder.Entity("HomeInv.Persistence.Dbo.ItemStock", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 12, 21, 37, 18, 703, DateTimeKind.Utc).AddTicks(7984));
