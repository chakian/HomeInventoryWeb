...
namespace HomeInv.Persistence.Migrations
{
    ...
    [Migration("20230618150206_AddedItemDefIdToShopListItem")]
    partial class AddedItemDefIdToShopListItem
    {
            ...
            modelBuilder.Entity("HomeInv.Persistence.Dbo.ShoppingListItem", b =>
                {
                    ...
                    b.HasOne("HomeInv.Persistence.Dbo.ShoppingList", "ShoppingList")
                        .WithMany("Items")
